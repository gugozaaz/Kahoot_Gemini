...
export default function HostView() {
  ...
  if (gameState === 'LOBBY') {
    return (
      <div className="host-container">
        ...
        {players.length > 0 && (
          <button className="btn-primary" onClick={() => runHostAction('start-game')}>Start Game</button>
        )}
      </div>
    );
  }
  ...
  if (gameState === 'QUESTION_PREVIEW') {
    return (
      <div className="host-container" style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', padding: '20px', overflow: 'hidden', backgroundColor: 'var(--theme-yellow)' }}>
      ...
      <div className="host-container" style={{ position: 'relative', display: 'flex', flexDirection: 'column', height: '100vh', padding: '20px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '20px' }}>
            <button className="btn-primary" onClick={() => runHostAction('show-leaderboard')}>Next</button>
          </div>
    ...
    return (
      <div className="host-container">
        <div className="leaderboard">
          ...
          <button className="btn-primary" onClick={() => runHostAction('next-question')} style={{ width: '100%', marginTop: '20px' }}>Next Question</button>
        </div>
      </div>
    );
  }
